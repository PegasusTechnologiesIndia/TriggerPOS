...
public class CustomerReturnListActivity extends AppCompatActivity {
  ...
  //  Settings settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            // Gettting customer return list here
            getStockList("");
        }
        catch(Exception e){
    ...
    public void setView(final String voucher_no) {
        ...
        if (returns != null) {
            ...
            Toast.makeText(getApplicationContext(), getString(R.string.somethngwentwrong), Toast.LENGTH_SHORT).show();
            listDialog.dismiss();
        }
...
//                    activity.displayMessage("Email sent.");
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(getApplicationContext(), getString(R.string.emailfailtosend), Toast.LENGTH_SHORT).show();
                        }
                    });
...
//                activity.displayMessage("Authentication failed.");
                ...
                Log.e(ReportViewerActivity.SendEmailAsyncTask.class.getName(), getString(R.string.emailfailed));
                e.printStackTrace();
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(getApplicationContext(), getString(R.string.emailfailsend), Toast.LENGTH_SHORT).show();
                    }
                });
...
//                activity.displayMessage("Email failed to send.");
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(getApplicationContext(), getString(R.string.unnexperror), Toast.LENGTH_SHORT).show();
                    }
                });
