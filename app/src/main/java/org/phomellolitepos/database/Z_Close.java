...
public class Z_Close {

    private static String tableName = "z_close";
    private String z_no;
    ...
    public Z_Close(Context context, String z_no, String z_code, String device_code, String date, String total_amount, String is_active, String modified_by, String modified_date, String is_push) {
    ...
    public void set_total_amount(String total_amount) {
        ...
        value.put("total_amount", total_amount);
    }
    ...
    public static long delete_Z_Close(Context context, String tablename, String whereClause, String[] whereArgs, SQLiteDatabase database) {
    ...
    public long updateZ_Close(String whereClause, String[] whereArgs, SQLiteDatabase database)
    ...
    public static Z_Close getZ_Close(Context context, String WhereClasue, SQLiteDatabase database, Database db) {
...
//        SQLiteDatabase database = db.getReadableDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
                master = new Z_Close(context, cursor.getString(0),
...
//        db.close();
    ...
    public static ArrayList<Z_Close> getAllZ_Close(Context context, String WhereClasue, SQLiteDatabase database) {
        String Query = "Select * FROM " + tableName + " " + WhereClasue;
        ArrayList<Z_Close> list = new ArrayList<Z_Close>();
        Z_Close master = null;
//        Database db = new Database(context);
//        SQLiteDatabase database = db.getReadableDatabase();
        Cursor cursor = database.rawQuery(Query, null);
