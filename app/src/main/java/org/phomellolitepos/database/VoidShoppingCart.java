...
public class VoidShoppingCart {
    ...
    public VoidShoppingCart(Context context, String SRNO, String Item_Code, String Item_Name, String Quantity,
                        String Cost_Price, String Sales_Price, String Tax_Price, String Discount, String Line_Total, String ismodifier, String masteritem, String category_Ip,String voidktchenflag
    ) {
        ...
        this.setVoidkitchenflag(voidktchenflag);
    }


    public String getVoidkitchenflag() {
        return voidkitchenflag;
    }

    public void setVoidkitchenflag(String voidkitchenflag) {
        this.voidkitchenflag = voidkitchenflag;
    }
