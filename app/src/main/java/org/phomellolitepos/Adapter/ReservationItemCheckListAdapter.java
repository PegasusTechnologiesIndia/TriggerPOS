...
public class ReservationItemCheckListAdapter extends ArrayAdapter<ReservationItemCheck> {
    private final Activity context;
    LayoutInflater inflater;
    String result1;
    ArrayList<ReservationItemCheck> list;
    ...
    public ReservationItemCheckListAdapter(Activity context, ArrayList<ReservationItemCheck> list) {
