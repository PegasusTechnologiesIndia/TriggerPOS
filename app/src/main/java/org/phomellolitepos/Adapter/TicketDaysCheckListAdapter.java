...
public class TicketDaysCheckListAdapter extends ArrayAdapter<TicketDaysCheck>{

    private final Activity context;
    LayoutInflater inflater;
    String result1;
    ArrayList<TicketDaysCheck> list;
    boolean[] itemChecked;
    ...
    public TicketDaysCheckListAdapter(Activity context, ArrayList<TicketDaysCheck> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        TicketDaysCheckListAdapter.ViewHolder viewHolder = null;
        if (convertView == null) {
            LayoutInflater inflator = context.getLayoutInflater();
            convertView = inflator.inflate(R.layout.tax_item_check_list_item, null);
            viewHolder = new TicketDaysCheckListAdapter.ViewHolder();
            ...
            viewHolder = (TicketDaysCheckListAdapter.ViewHolder) convertView.getTag();
        }
