...
public class TicketCategoryCheckListAdapter  extends ArrayAdapter<TicketCategoryCheck> {

    private final Activity context;
    LayoutInflater inflater;
    String result1;
    ArrayList<TicketCategoryCheck> list;
    boolean[] itemChecked;
    ...
    public TicketCategoryCheckListAdapter(Activity context, ArrayList<TicketCategoryCheck> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        TicketCategoryCheckListAdapter.ViewHolder viewHolder = null;
        if (convertView == null) {
            LayoutInflater inflator = context.getLayoutInflater();
            convertView = inflator.inflate(R.layout.tax_item_check_list_item, null);
            viewHolder = new TicketCategoryCheckListAdapter.ViewHolder();
            ...
            viewHolder = (TicketCategoryCheckListAdapter.ViewHolder) convertView.getTag();
        }
