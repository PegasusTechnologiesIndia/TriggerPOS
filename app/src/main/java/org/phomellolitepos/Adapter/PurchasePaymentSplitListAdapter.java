...
import org.phomellolitepos.PusrchasePaymentActivity;
...
public class PurchasePaymentSplitListAdapter extends BaseAdapter{
    ...
    public PurchasePaymentSplitListAdapter(Context context,
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                data.remove(i);
                ((PusrchasePaymentActivity) context).setTextView(finalAmount + "");
                return true;
            }
        });
