...
public class OrderDetailReport_View extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<OrderDetail_Report> orderdetailreportArrayList ;
    OrderDetailReport_Adapter orderHeaderReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oder_detail_report__view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Sales By Item");
        ...
        orderdetailreportArrayList =new ArrayList<OrderDetail_Report>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(OrderDetailReport_View.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(OrderDetailReport_View.this, ReportActivity.class);
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String itemname=cursor.getString(3);
                 ordertype=cursor.getString(4);
                String saleprice= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                //   String taxAmnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                String quantity=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(6)),qty_decimal_check);
                String grossamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(7)),qty_decimal_check);
                String discountamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(8)),qty_decimal_check);
                String amountafterdisc=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(9)),qty_decimal_check);
                String netamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(10)),qty_decimal_check);
                ...
                orderdetailreportArrayList.add(new OrderDetail_Report(itemCategory,itemcode,itemname,ordertype,saleprice,quantity,grossamount,discountamount,amountafterdisc,netamount));
    ...
    private void getReportList() {
        ...
        if (orderdetailreportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);



            orderHeaderReportAdapter = new OrderDetailReport_Adapter(OrderDetailReport_View.this, orderdetailreportArrayList);
...
flag="1";
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        OrderDetailReport_View activity;
