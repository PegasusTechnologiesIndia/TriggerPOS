...
import org.phomellolitepos.Adapter.OrderHeaderReportAdapter;
...
public class OrderHeaderReport_View extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<OrderHeaderReport> orderHeaderReportArrayList ;
    OrderHeaderReportAdapter orderHeaderReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_header_report__view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Order Header");
        ...
        orderHeaderReportArrayList =new ArrayList<OrderHeaderReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(OrderHeaderReport_View.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(OrderHeaderReport_View.this, ReportActivity.class);
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
               ...
               salesperson= cursor.getString(4);
                ...
                String totalitem=cursor.getString(6);
                String totalquantity=cursor.getString(7);
                String remarks=cursor.getString(8);
                String amount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(9)),qty_decimal_check);
                String discountper=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(10)),qty_decimal_check);
                String discountamnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(11)),qty_decimal_check);
                String amountafterdis=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(12)),qty_decimal_check);
                String netamnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(13)),qty_decimal_check);
                String ordertype=cursor.getString(14);
                String contact=cursor.getString(15);
                ...
                totalamnt.setText("  "+ Globals.myNumberFormat2Price(count_amnt_summry,decimal_check)+" ");
                    ...
                    orderHeaderReportArrayList.add(new OrderHeaderReport(invoicenumber,date,time,salesperson,devicename,totalitem,totalquantity,remarks,amount,discountper,discountamnt,amountafterdis,netamnt,ordertype));
...
flag="1";
            ...
            orderHeaderReportAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        OrderHeaderReport_View activity;
