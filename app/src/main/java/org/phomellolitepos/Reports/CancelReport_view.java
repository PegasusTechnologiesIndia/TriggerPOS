...
import org.phomellolitepos.Adapter.ContactReportAdapter;
...
public class CancelReport_view extends AppCompatActivity
{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<CancelReport> cancelReportArrayList ;
    CancelReportAdapter cancelReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_cancel_report_view);
        ...
        cancelReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(CancelReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(CancelReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                String invoiceNum=colCursor.getString(1);
                String date=colCursor.getString(2);
                String time=colCursor.getString(3);
                String salesperson=colCursor.getString(4);
                String deviceName =colCursor.getString(5);
                String amtWithouttax=colCursor.getString(7);
                String disPer=colCursor.getString(8);
                String disAmt=colCursor.getString(9);
                String amtafterdis=colCursor.getString(10);
                String taxAmt=colCursor.getString(11);
                String netAmt=colCursor.getString(12);
                String ordertype=colCursor.getString(13);
                String contact=colCursor.getString(14);
                cancelReportArrayList.add(new CancelReport( invoiceNum,  date,  time,salesperson,deviceName,  amtWithouttax,disPer,  disAmt,  amtafterdis,taxAmt,netAmt,ordertype,contact));
    ...
    private void getReportList() {
        ...
        if (cancelReportArrayList.size() > 0) {
            ...
            flag="1";
            cancelReportAdapter.notifyDataSetChanged();
