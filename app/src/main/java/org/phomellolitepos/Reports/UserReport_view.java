...
import org.phomellolitepos.Adapter.UserReportAdapter;
...
public class UserReport_view extends AppCompatActivity
{
        Database db;
        SQLiteDatabase database;
        TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
        ArrayList<UserReport> userReportArrayList ;
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progressDialog = new ProgressDialog(UserReport_view.this);
...
//                          sleep(1000);
                                ...
                                Globals.pageNO = 0;
                                Intent intent = new Intent(UserReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                String usercode=colCursor.getString(1);
                String username=colCursor.getString(2);
                String useremail=colCursor.getString(3);
                String maxDis=colCursor.getString(4);

                userReportArrayList.add(new UserReport(usercode,username,useremail,maxDis));
        ...
        if (userReportArrayList.size() > 0) {
            ...
            userReportAdapter = new UserReportAdapter(UserReport_view.this, userReportArrayList);
            //table_title.setVisibility(View.INVISIBLE);
            order_list.setVisibility(View.VISIBLE);
            order_list.setAdapter(userReportAdapter);
