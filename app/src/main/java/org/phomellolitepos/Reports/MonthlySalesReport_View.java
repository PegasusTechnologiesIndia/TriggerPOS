...
import org.phomellolitepos.Adapter.MonthlyReportAdapter;
...
public class MonthlySalesReport_View extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<MonthlySalesReport> monthlySalesReportArrayList ;
    MonthlyReportAdapter monthlySalesReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monthly_sales_report__view);
        ...
        monthlySalesReportArrayList =new ArrayList<MonthlySalesReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(MonthlySalesReport_View.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(MonthlySalesReport_View.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String totalinvoice= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(2)),qty_decimal_check);
                String netamnt= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(3)),qty_decimal_check);
                //   String taxAmnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                String amnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(4)),qty_decimal_check);
                String month=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                String year=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(6)),qty_decimal_check);
                //     String location=cursor.getString(9);
                String ordertype=cursor.getString(8);
                String discountamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(9)),qty_decimal_check);
                ...
                txtsalesperson.setText(userid);
                txt_ordertype.setText(ordertype);
                monthlySalesReportArrayList.add(new MonthlySalesReport(userid,devicename,totalinvoice,netamnt,amnt,month,year,"",ordertype,discountamount));
    ...
    private void getReportList() {
        ...
        if (monthlySalesReportArrayList.size() > 0) {
            ...
            monthlySalesReportAdapter.notifyDataSetChanged();
    ...
    public class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        MonthlySalesReport_View activity;
