...
import org.phomellolitepos.Adapter.ZerReportAdapter;
...
public class ZeroReportView extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<ZeroReport> zeroReportArrayList;
    ZerReportAdapter zerReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zero_report_view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Zero Report");
        ...
        zeroReportArrayList =new ArrayList<ZeroReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ZeroReportView.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(ZeroReportView.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String Openingbal=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(3)),qty_decimal_check);
                String  expense=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(4)),qty_decimal_check);
                String cashales= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                //   String taxAmnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                String accountcash=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(6)),qty_decimal_check);
                String totalreturn=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(7)),qty_decimal_check);
                String totalcash=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(8)),qty_decimal_check);
                String zcode=cursor.getString(9);
                ...
                count_amnt_summry += Double.parseDouble(totalcash);
                totalamnt.setText("  " + Globals.myNumberFormat2Price(count_amnt_summry,decimal_check)+"");

                zeroReportArrayList.add(new ZeroReport(devicename,date,Openingbal,expense,cashales,accountcash,totalreturn,totalcash,zcode));
...
flag="1";
            zerReportAdapter.notifyDataSetChanged();
