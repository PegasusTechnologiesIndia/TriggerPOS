...
public class DailySales_Report extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<DailySalesReport> dailySalesReportArrayList ;
    DailySalesReportAdapter dailySalesReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dailySalesReportArrayList =new ArrayList<org.phomellolitepos.database.DailySalesReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(DailySales_Report.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(DailySales_Report.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String amtWithouttax= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(3)),qty_decimal_check);
                String amtAfterdis= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(4)), qty_decimal_check);
                String taxAmt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                String netAmt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(6)),qty_decimal_check);
                String totalinv=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(7)),qty_decimal_check);
                String disAmt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(8)),qty_decimal_check);
                ...
                count_amnt_summry += Double.parseDouble(netAmt);
                ...
                dailySalesReportArrayList.add(new DailySalesReport(netAmt,amtWithouttax,amtAfterdis,taxAmt, totalinv,disAmt,ordertype));
    ...
    private void getReportList() {
        ...
        if (dailySalesReportArrayList.size() > 0) {
            ...
            flag="1";
            dailySalesReportAdapter.notifyDataSetChanged();
