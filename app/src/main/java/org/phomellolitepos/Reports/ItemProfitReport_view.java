...
import org.phomellolitepos.Adapter.ItemProfitReportAdapter;
...
public class ItemProfitReport_view extends AppCompatActivity {


    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<ItemProfitReport> itemProfitReportArrayList ;
    ItemProfitReportAdapter itemProfitReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("Item Profit Report ");
        ...
        itemProfitReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ItemProfitReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(ItemProfitReport_view.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToNext())
        {
            ...
            do {
                ...
                String costprice=colCursor.getString(3);
                String saleprice=colCursor.getString(4);
                String qty =colCursor.getString(5);
                String netprofit=colCursor.getString(6);
                String netprofitPer=colCursor.getString(7);

                itemProfitReportArrayList.add(new ItemProfitReport(itemcode,  itemname,  costprice,saleprice,qty,  netprofit,netprofitPer));
    ...
    private void getReportList() {
        ...
        if (itemProfitReportArrayList.size() > 0) {
            ...
            flag="1";
            itemProfitReportAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        ItemProfitReport_view activity;
