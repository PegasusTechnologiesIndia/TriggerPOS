...
import org.phomellolitepos.Adapter.SalesByItremGroupAdapter;
...
public class SalesByItemGroupReport_View extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<SalesByItemGroup> salesByItemGroupArrayList ;
    SalesByItremGroupAdapter salesByItremGroupAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_by_item_group_report__view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Sales By Item Group");
        ...
        salesByItemGroupArrayList =new ArrayList<SalesByItemGroup>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(SalesByItemGroupReport_View.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(SalesByItemGroupReport_View.this, ReportActivity.class);
        ...
        try {
            ...
            if (colCursor.moveToFirst())
            {
                ...
                do {
                    ...
                    String saleprice= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(2)),qty_decimal_check);
                    String quantity= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(3)),qty_decimal_check);
                    String grossamount= Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(4)),qty_decimal_check);
                    //   String taxAmnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                    String discamnt=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(5)),qty_decimal_check);
                    String amountafterdis=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(6)),qty_decimal_check);
                    String netamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(7)),qty_decimal_check);
                    ...
                    salesByItemGroupArrayList.add(new SalesByItemGroup(itemcategory,saleprice,quantity,grossamount,discamnt,amountafterdis,netamount));
...
flag="1";
            salesByItremGroupAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        SalesByItemGroupReport_View activity;
