...
import org.phomellolitepos.Adapter.VatOrderHeaderReportAdapter;
...
public class VatOrderHeaderReport_view extends AppCompatActivity
{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<VatOrderHeaderReport> vatOrderHeaderReportArrayList ;
    VatOrderHeaderReportAdapter vatOrderHeaderReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_vat_order_header_report_view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Vat Order Header Report ");
        ...
        vatOrderHeaderReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(VatOrderHeaderReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(VatOrderHeaderReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                String orderCode=colCursor.getString(1);
                String orderDate=colCursor.getString(2);
                String amtWithoutTax=colCursor.getString(5);
                String disAmt=colCursor.getString(6);
                String totalVat =colCursor.getString(7);
                String invoiceAmt=colCursor.getString(8);
                vatOrderHeaderReportArrayList.add(new VatOrderHeaderReport(orderCode, orderDate,  amtWithoutTax,  disAmt,totalVat,invoiceAmt));
    ...
    private void getReportList() {
        ...
        if (vatOrderHeaderReportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);


            vatOrderHeaderReportAdapter = new VatOrderHeaderReportAdapter(VatOrderHeaderReport_view.this, vatOrderHeaderReportArrayList);
            //table_title.setVisibility(View.INVISIBLE);
            order_list.setVisibility(View.VISIBLE);
            order_list.setAdapter(vatOrderHeaderReportAdapter);
            ...
            flag="1";
            vatOrderHeaderReportAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        VatOrderHeaderReport_view activity;
