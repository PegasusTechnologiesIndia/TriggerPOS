...
import org.phomellolitepos.Adapter.CancelReportAdapter;
import org.phomellolitepos.Adapter.GST_OrderHeaderReportAdapter;
...
public class GstOrderHeaderReport_view extends AppCompatActivity {


        Database db;
        SQLiteDatabase database;
        TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
        ArrayList<GST_OrderHeaderReport> gstOrderHeaderReportArrayList ;
        GST_OrderHeaderReportAdapter gstOrderHeaderReportAdapter;
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            setContentView(R.layout.activity_contact_report_view);
            getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
            Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
            setSupportActionBar(toolbar);
            getSupportActionBar().setTitle("Cancel Report ");
            ...
            gstOrderHeaderReportArrayList =new ArrayList<>();
            intent=getIntent();
            ...
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progressDialog = new ProgressDialog(GstOrderHeaderReport_view.this);
...
//                          sleep(1000);
                                ...
                                Globals.pageNO = 0;
                                Intent intent = new Intent(GstOrderHeaderReport_view.this, ReportActivity.class);
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String orderNo=colCursor.getString(1);
                String orderDate=colCursor.getString(2);
                String amtWithouttax=colCursor.getString(5);
                String disPer=colCursor.getString(6);
                String disAmt=colCursor.getString(7);
                String amtafterdis=colCursor.getString(8);
                String cgstPer=colCursor.getString(9);
                String cgstAmt =colCursor.getString(10);
                String sgstPer=colCursor.getString(11);
                String sgstAmt=colCursor.getString(12);
                String igstPer=colCursor.getString(13);
                String igstAmt=colCursor.getString(14);
                String totalGst=colCursor.getString(15);
                String invoiceAmt=colCursor.getString(16);
                gstOrderHeaderReportArrayList.add(new GST_OrderHeaderReport( orderNo,  orderDate,  amtWithouttax,disPer,disAmt,  amtafterdis,cgstPer,  cgstAmt,  sgstPer,sgstAmt,igstPer,igstAmt,totalGst,invoiceAmt));
        ...
        if (gstOrderHeaderReportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);


            gstOrderHeaderReportAdapter = new GST_OrderHeaderReportAdapter(GstOrderHeaderReport_view.this, gstOrderHeaderReportArrayList);
            //table_title.setVisibility(View.INVISIBLE);
            order_list.setVisibility(View.VISIBLE);
            order_list.setAdapter(gstOrderHeaderReportAdapter);
            ...
            flag="1";
            gstOrderHeaderReportAdapter.notifyDataSetChanged();
        ...
        class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
            GMailSender m;
            GstOrderHeaderReport_view activity;
