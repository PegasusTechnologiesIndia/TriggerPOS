...
public class ContactReport_view extends AppCompatActivity{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<ContactReport> contactReportArrayList ;
    ContactReportAdapter contactReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("Contact Report ");
        ...
        contactReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ContactReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(ContactReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                String contactCode=colCursor.getString(1);
                String title=colCursor.getString(2);
                String name=colCursor.getString(3);
                String gender=colCursor.getString(4);
                String dob =colCursor.getString(5);
                String contact1=colCursor.getString(7);
                String email=colCursor.getString(9);
                String creditLimit=colCursor.getString(11);
                String gstn=colCursor.getString(12);
                contactReportArrayList.add(new ContactReport(srno, contactCode,  title,  name,gender,dob,  contact1,email,  creditLimit,  gstn));
    ...
    private void getReportList() {
        ...
        if (contactReportArrayList.size() > 0) {
            ...
            flag="1";
            contactReportAdapter.notifyDataSetChanged();
