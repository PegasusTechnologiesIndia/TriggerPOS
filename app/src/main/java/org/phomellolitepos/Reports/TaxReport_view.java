...
public class TaxReport_view extends AppCompatActivity {

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<TaxReport> taxReportArrayList;
    TaxReportAdapter taxReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        taxReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(TaxReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(TaxReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                taxReportArrayList.add(new TaxReport(taxId,taxName,taxType,taxRate));
    ...
    private void getReportList() {
        ...
        if (taxReportArrayList.size() > 0) {
            ...
            flag="1";
            taxReportAdapter.notifyDataSetChanged();
