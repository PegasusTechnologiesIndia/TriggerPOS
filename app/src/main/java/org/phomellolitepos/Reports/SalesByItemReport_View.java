...
import org.phomellolitepos.Adapter.SalesByItemAdapter;
...
public class SalesByItemReport_View extends AppCompatActivity {
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<SalesByItemReport> salesByItemReportArrayList ;
    SalesByItemAdapter salesByItremGroupAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_by_item_report__view);
        ...
        salesByItemReportArrayList =new ArrayList<SalesByItemReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(SalesByItemReport_View.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(SalesByItemReport_View.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String ordertype=cursor.getString(7);
                String saleprice=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(8)),qty_decimal_check);
                String quantity=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(9)),qty_decimal_check);
                String grossamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(10)),qty_decimal_check);
                String discamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(11)),qty_decimal_check);
                String netamount=Globals.myNumberFormat2Price(Double.parseDouble(cursor.getString(12)),qty_decimal_check);
                ...
                count_amnt_summry = count_amnt_summry + Double.parseDouble(netamount);
                totalamnt.setText("  "+Globals.myNumberFormat2Price(count_amnt_summry,decimal_check)+"");

               salesByItemReportArrayList.add(new SalesByItemReport(invoicenumber,date,time,itemcategory,itemcode,itemname,ordertype,saleprice,quantity,grossamount,netamount,discamount));
    ...
    private void getReportList() {
        ...
        if (salesByItemReportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);


            salesByItremGroupAdapter = new SalesByItemAdapter(SalesByItemReport_View.this, salesByItemReportArrayList);
...
flag="1";
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        SalesByItemReport_View activity;
