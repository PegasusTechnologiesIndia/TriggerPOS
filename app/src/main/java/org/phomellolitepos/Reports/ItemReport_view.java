...
import org.phomellolitepos.Adapter.ItemReportAdapter;
...
public class ItemReport_view extends AppCompatActivity
{
    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt, totalRecord;
    ArrayList<ItemReport> itemReportArrayList ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_report_view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Item Report");
        ...
        itemReportArrayList =new ArrayList<ItemReport>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ItemReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(ItemReport_view.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
       ...
       /*         String userid= cursor.getString(0);
                ...
                */
                ...
                colCursor.getString(2);
                String itemcode=colCursor.getString(3);
                String itemname=colCursor.getString(4);
                String costprice=colCursor.getString(5);
                String salesprice=colCursor.getString(6);
                String newsaleprice=colCursor.getString(7);
                itemReportArrayList.add(new ItemReport(itemcode,itemname,costprice,salesprice,newsaleprice));
