...
import org.phomellolitepos.Adapter.GstOrderItemReportAdapter;
...
public class GstOrderItemReport_view extends AppCompatActivity
{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<GstOrderItemReport> gstOrderItemReportArrayList ;
    GstOrderItemReportAdapter gstOrderItemReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_gst_order_item_report_view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Order Item Report ");
        ...
        gstOrderItemReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(GstOrderItemReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(GstOrderItemReport_view.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                String itemNo=colCursor.getString(0);
                String itemCategory=colCursor.getString(1);
                String itemName=colCursor.getString(2);
                String hsnCode=colCursor.getString(3);
                String invoiceNo=colCursor.getString(4);
                String dateTime=colCursor.getString(5)+" "+colCursor.getString(6);
                String salesPricewithouttax=colCursor.getString(8);
                String qty=colCursor.getString(9);
                String uom=colCursor.getString(10);
                String GrossAmtWithoutTax=colCursor.getString(11);
                String disPer=colCursor.getString(12);
                String disAmt=colCursor.getString(13);
                String amtAfterdis=colCursor.getString(14);
                String cgstPer=colCursor.getString(15);
                String cgstAmt =colCursor.getString(16);
                String sgstPer=colCursor.getString(17);
                String sgstAmt=colCursor.getString(18);
                String igstPer=colCursor.getString(19);
                String igstAmt=colCursor.getString(20);
                String totaltax=colCursor.getString(21);
                String netAmt=colCursor.getString(22);
                gstOrderItemReportArrayList.add(new GstOrderItemReport( itemNo,itemCategory,itemName,hsnCode,invoiceNo,dateTime,salesPricewithouttax,qty,uom,GrossAmtWithoutTax,disPer,disAmt,amtAfterdis,cgstPer,cgstAmt,sgstPer,sgstAmt,igstPer,igstAmt,totaltax,netAmt));
    ...
    private void getReportList() {
        ...
        if (gstOrderItemReportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);


            gstOrderItemReportAdapter = new GstOrderItemReportAdapter(GstOrderItemReport_view.this, gstOrderItemReportArrayList);
            //table_title.setVisibility(View.INVISIBLE);
            order_list.setVisibility(View.VISIBLE);
            order_list.setAdapter(gstOrderItemReportAdapter);
            ...
            flag="1";
            gstOrderItemReportAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        GstOrderItemReport_view activity;
