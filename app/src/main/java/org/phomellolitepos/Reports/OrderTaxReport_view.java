...
import org.phomellolitepos.Adapter.OrderTaxReportAdapter;
...
public class OrderTaxReport_view extends AppCompatActivity
{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<OrderTaxReport> orderTaxReportArrayList;
    OrderTaxReportAdapter orderTaxReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("Order Tax Report ");
        ...
        orderTaxReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(OrderTaxReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(OrderTaxReport_view.this, ReportActivity.class);
...
//                txt_ordertype.setText(ordertype);
                ...
                String taxid=colCursor.getString(1);
                String taxname=colCursor.getString(2);
                String taxtype=colCursor.getString(3);
                String taxrate=colCursor.getString(4);
                String name=colCursor.getString(5);
                orderTaxReportArrayList.add(new OrderTaxReport(taxid,taxname,taxtype,taxrate,name));
    ...
    private void getReportList() {
        ...
        if (orderTaxReportArrayList.size() > 0) {
            ...
            flag="1";
            orderTaxReportAdapter.notifyDataSetChanged();
