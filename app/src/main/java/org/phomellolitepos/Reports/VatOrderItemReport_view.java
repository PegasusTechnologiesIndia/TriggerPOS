...
import org.phomellolitepos.Adapter.VatOrderItemReportAdapter;
...
public class VatOrderItemReport_view extends AppCompatActivity
{

    Database db;
    SQLiteDatabase database;
    TextView txt_compname,txt_add,txt_date,txtsalesperson,txt_ordertype,totalamnt,totalRecord;
    ArrayList<VatOrderItemReport> vatOrderItemReportArrayList ;
    VatOrderItemReportAdapter vatOrderItemReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_vat_order_item_report_view);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Vat Order Item Report ");
        ...
        vatOrderItemReportArrayList =new ArrayList<>();
        intent=getIntent();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(VatOrderItemReport_view.this);
...
//                          sleep(1000);
                            ...
                            Globals.pageNO = 0;
                            Intent intent = new Intent(VatOrderItemReport_view.this, ReportActivity.class);
    ...
    public void getqry1(String qry){
        ...
        if (colCursor.moveToFirst())
        {
            ...
            do {
                ...
                String srno=colCursor.getString(0);
                String itemCategory=colCursor.getString(1);
                String itemCode=colCursor.getString(2);
                String itemName=colCursor.getString(3);
                String hsnCode=colCursor.getString(4);
                String invoiceNo=colCursor.getString(5);
                String dateTime=colCursor.getString(6)+" "+colCursor.getString(7);
                String DeviceName=colCursor.getString(8);
                String salesPricewithouttax=colCursor.getString(10);
                String qty=colCursor.getString(11);
                String uom=colCursor.getString(12);
                String GrossAmtWithoutTax=colCursor.getString(13);
                String disPer=colCursor.getString(14);
                String disAmt=colCursor.getString(15);
                String amtAfterdis=colCursor.getString(16);
                String totalVat=colCursor.getString(17);
                String netAmt=colCursor.getString(18);
                vatOrderItemReportArrayList.add(new VatOrderItemReport(itemCategory,itemCode,itemName,hsnCode,invoiceNo,dateTime,DeviceName,salesPricewithouttax,qty,uom,GrossAmtWithoutTax,disPer,disAmt,amtAfterdis,totalVat,netAmt));
    ...
    private void getReportList() {
        ...
        if (vatOrderItemReportArrayList.size() > 0) {

            // order_arraylist = Orders.getAllOrders(getApplicationContext(), "WHERE is_active = '1' AND order_status ='OPEN' And z_code='0'", database);


            vatOrderItemReportAdapter = new VatOrderItemReportAdapter(VatOrderItemReport_view.this, vatOrderItemReportArrayList);
            //table_title.setVisibility(View.INVISIBLE);
            order_list.setVisibility(View.VISIBLE);
            order_list.setAdapter(vatOrderItemReportAdapter);
            ...
            flag="1";
            vatOrderItemReportAdapter.notifyDataSetChanged();
    ...
    class SendEmailAsyncTask extends AsyncTask<Void, Void, Boolean> {
        GMailSender m;
        VatOrderItemReport_view activity;
